 ...
 * @generated
 */
public class Afd2Switch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static Afd2Package modelPackage;
	...
	public Afd2Switch() {
		if (modelPackage == null) {
			modelPackage = Afd2Package.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Afd2Package.AFD: {
			AFD afd = (AFD) theEObject;
			T result = caseAFD(afd);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>AFD</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>AFD</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAFD(AFD object) {
		return null;
	}
