...
public class InternalTransitionImpl extends MinimalEObjectImpl.Container implements InternalTransition {
			...
			if (targetState != oldTargetState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DevsPackage.INTERNAL_TRANSITION__TARGET_STATE, oldTargetState, targetState));
			}
		}
		return targetState;
	}
	...
	public NotificationChain basicSetTargetState(State newTargetState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DevsPackage.INTERNAL_TRANSITION__TARGET_STATE, oldTargetState, newTargetState);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setTargetState(State newTargetState) {
		if (newTargetState != targetState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DevsPackage.INTERNAL_TRANSITION__TARGET_STATE,
	...
	public State getSourceState() {
		if (sourceState != null && sourceState.eIsProxy()) {
			...
			if (sourceState != oldSourceState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DevsPackage.INTERNAL_TRANSITION__SOURCE_STATE, oldSourceState, sourceState));
			}
		}
		return sourceState;
	}
	...
	public NotificationChain basicSetSourceState(State newSourceState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DevsPackage.INTERNAL_TRANSITION__SOURCE_STATE, oldSourceState, newSourceState);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setSourceState(State newSourceState) {
		if (newSourceState != sourceState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DevsPackage.INTERNAL_TRANSITION__SOURCE_STATE,
