 ...
 * </p>
 * <ul>
 *   <li>{@link atomicDevs.impl.InputPortImpl#getInput <em>Input</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InputPortImpl extends PortImpl implements InputPort {
	...
	protected EClass eStaticClass() {
		return AtomicDevsPackage.Literals.INPUT_PORT;
	}
	...
	public EList<Input> getInput() {
		if (input == null) {
			input = new EObjectWithInverseResolvingEList<Input>(Input.class, this, AtomicDevsPackage.INPUT_PORT__INPUT,
					AtomicDevsPackage.INPUT__INPUTPORT);
		}
		return input;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case AtomicDevsPackage.INPUT_PORT__INPUT:
