...
public class PortImpl extends MinimalEObjectImpl.Container implements Port {
	...
	protected EClass eStaticClass() {
		return AtomicDevsPackage.Literals.PORT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtomicDevsPackage.PORT__NAME, oldName, name));
	}
	...
	public void setVariable(String newVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtomicDevsPackage.PORT__VARIABLE, oldVariable,
					variable));
	}
	...
	public Type getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AtomicDevsPackage.PORT__TYPE, oldType,
							type));
			}
		}
		return type;
	...
	public void setType(Type newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtomicDevsPackage.PORT__TYPE, oldType, type));
	}
