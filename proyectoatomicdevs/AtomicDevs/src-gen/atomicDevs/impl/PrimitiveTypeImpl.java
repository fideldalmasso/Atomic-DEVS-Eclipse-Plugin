 ...
 * </p>
 * <ul>
 *   <li>{@link atomicDevs.impl.PrimitiveTypeImpl#getPrimitive <em>Primitive</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimitiveTypeImpl extends TypeImpl implements PrimitiveType {
	...
	protected EClass eStaticClass() {
		return AtomicDevsPackage.Literals.PRIMITIVE_TYPE;
	}
	...
	public void setPrimitive(Primitive newPrimitive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtomicDevsPackage.PRIMITIVE_TYPE__PRIMITIVE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case AtomicDevsPackage.PRIMITIVE_TYPE__PRIMITIVE:
			return getPrimitive();
		}
